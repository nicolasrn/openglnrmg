...
e,E pour la taille d'affichage en X
d,D pour la taille d'affichage en Y 
t et T pour régler le zoom ?????
...
static int proj = 0 ;
static int vp = 1 ; /* booleen sur le viewport */
static int vx = 0 ; /* position vp en x */
static int vy = 0 ; /* position vp en y */
static int vdx = 200 ; /* taille zone affichage en x */
static int vdy = 200 ; /* taille zone affichage en y */
static int ww ;
static int hh ;
