...
#ifndef __MON_GLUTSOLIDCUBE__
#define __MON_GLUTSOLIDCUBE__
...
void monGlutSolidCube(GLdouble size, int tailleTexture = 1, int posx = -1, int posy = -1, void (*normal)(int, int) = &Normal);
